...
- The workspace server already preinstalls Node.js, npm, create-vite, Vite, React, React DOM, and TypeScript tooling; for full-stack web app requests, skip global toolchain installs and move directly to scaffolding and implementation.
